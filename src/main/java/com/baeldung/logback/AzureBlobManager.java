...
public final class AzureBlobManager {
	...
	public AzureBlobManager(String name, String storageAccount, String accountKey, String container,
			String endpointSuffix) throws InvalidKeyException, URISyntaxException, StorageException {

		storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=" + storageAccount + ";AccountKey="
				+ accountKey
				+ ((endpointSuffix != null && endpointSuffix.trim().length() > 0)
						? (";EndpointSuffix=" + endpointSuffix.trim())
						: "");
